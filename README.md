...
| `regex(value, pattern [, flags = "im"]): bool` | Tests a string for a [regular expression](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp).       | `not regex(methodName, "^(ZZZ)(\\s)(-)")`                                                             |
